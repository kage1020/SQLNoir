...
export function ProfileMenu({ isOpen, onClose, onSignOut, user }: ProfileMenuProps) {
  ...
  return (
    <>
      ...
      {/* Profile Menu */}
      <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-lg py-1 border border-amber-200 z-50">
        <div className="p-4 border-b border-amber-200">
          <div className="flex items-center justify-between mb-2">
            <h3 className="font-detective text-lg text-amber-900">Detective Profile</h3>
            <button
              onClick={onClose}
        ...
        <div className="p-4 border-b border-amber-200">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <p className="text-sm font-medium text-amber-900">Experience Points</p>
